class FileUpload {
    ...
    upload_file(start, model_id) {
        ...
        $.ajax({
            ...
            // need to make the url as input from some sort of a form for react app
            // maybe the url path black list needs to be implemented for a file upload process too
            url: 'api/v1/upload/',
            type: 'POST',
            // this datatype must be either restricted to only viewable one or any extension that user chooses
            dataType: 'json',
            cache: false,
            processData: false,
            contentType: false,
